...
outputFileName=multiParticle-${nevent}Events-Seed${seed}.slcio
...
cp ${PATH_TO_SiWSimulation}/python/src/multiParticle.py config.py
...
#xrdcp -f root://eosuser.cern.ch//eos/user/a/asteen/hgcal/simu/lcio/multiParticles/simcalorimeterhit/${outputFileName} ${outputFileName}
#rm ${outputFileName}
