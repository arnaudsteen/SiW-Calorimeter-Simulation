...
GunOptionPosition=cosmic #default, random, cosmic
GunOptionMomentum=cosmic_gaus #gaus, solidAngle, uniform, normal, cosmic_gaus, cosmic_uniform
GaussianMean=0.0
GaussianSigma=0.03
...
mv toto.slcio single_${particle}_${energy}GeV_COSMIC${seed}.slcio
mv testOutPut.root single_${particle}_${energy}GeV_COSMIC${seed}.root
